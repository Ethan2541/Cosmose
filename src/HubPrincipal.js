...
function HubPrincipal(props){
    ...
    useEffect(() => {
        ...
        if (theme == "etoile-blanche") {
            ...
            root.style.setProperty("--etoiles-color", "rgba(187,210,225,1)");
            ...
            root.style.setProperty("--message-bg-color", "rgba(255,255,255,0.8)");
            root.style.setProperty("--message-bordure-color", "rgba(0,0,0,0.25)");
            root.style.setProperty("--publication-bg-color", "rgba(255,255,255,0.8)");
            root.style.setProperty("--publication-color", "rgba(0,0,0,0.8)");
            ...
            root.style.setProperty("--message-bg-color", "rgba(23,21,33,0.8)");
            root.style.setProperty("--message-bordure-color", "rgba(140,107,203,0.25)");
            root.style.setProperty("--publication-bg-color", "rgba(23,21,33,0.8)");
            root.style.setProperty("--publication-color", "rgba(255,255,255,0.8)");
