...
function Banner(props) {
    ...
    return(
        <div id='banner'>
            ...
            <label id="banner-edit" onMouseEnter={ renderEditBanner } onMouseLeave={ hideEditBanner }>
            ...
            <label id="picture-edit" onMouseEnter={ renderEditPicture } onMouseLeave={ hideEditPicture }>
